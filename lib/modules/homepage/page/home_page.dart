import 'package:atg_project/modules/homepage/controller/home_page_controller.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      ...
      body: GetBuilder<HomepageController>(
          ...
          builder: (controller) {
            if (controller.allPost == null || controller.allPost1 == null) {
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: ListView.builder(
                              itemCount: controller.allPost!.items!.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return ProgramWidgetCard(
                                    style: controller
                                        .allPost!.items![index].category!,
                                    color: Color(0xffDDE3C2),
                                    heading:
                                        controller.allPost!.items![index].name!,
                                    noOfLessons: controller
                                        .allPost!.items![index].lesson!,
                        ...
                        SizedBox(
                            ...
                            width: double.infinity,
                            child: ListView.builder(
                              itemCount: controller.allPost1!.items!.length,
                              scrollDirection: Axis.horizontal,
                              itemBuilder: (context, index) {
                                return LessonCard(
                                  style: controller
                                      .allPost1!.items![index].category!,
                                  color: Color(0xffFFF0D3),
                                  heading:
                                      controller.allPost1!.items![index].name!,
                                  image:
                                      'assets/young-woman-doing-natarajasana-exercise1.png',
                                  minute: controller
                                      .allPost1!.items![index].duration!,
                                  isLocked: controller
                                      .allPost1!.items![index].locked!,
                                );
                              },
                            )
                            //   SizedBox(
